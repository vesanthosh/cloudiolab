                ...
                <div className="text-dark">
                    <div className="content mb-5">
                        ...
                        <div className="text-center mt-4 mb-4">
                            ...
                            <p>Please tell him to clean the laboratory (Codebase), if you see this guy. And don't forget to <a href="https://me.cloudiolab.com" target="_blank" rel="noopener noreferrer"><i>Hit Him!</i></a>.</p>
                        </div>
                        <hr />
